...
class AdminHeader extends React.Component {
  ...
  componentDidMount() {
    ...
    if (this.props.Credentials.isAuthenticated) {
      console.log(123);
      this.props.FetchUserDetailsAction(this.props.Credentials.user.id);
    }
  }
  ...
  render() {
    ...
    const authLinks = (
      <ul className="nav navbar-nav ml-auto mr-0">
        <li className="nav-item">
          {/* <Link to="/user/profile" className="btn btn-outline-white">
            Go To Profile
          </Link>
          &nbsp;&nbsp;&nbsp;&nbsp; */}
          {/* <Link
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <Link to="/admin/profile" className="btn btn-outline-white">
            My Profile
          </Link>{" "}
          &nbsp;&nbsp;&nbsp;&nbsp;
          <Link
    ...
    if (this.props.Settings) {
      console.log(this.props.Settings[0].colorTheme);
      return (
        <div
