        ...
        <div className="layout-boxed">
          ...
          >
            <div className="mdk-drawer-layout__content page-content">
              <Header />
              <div
                className="mdk-box mdk-box--bg bg-dark js-mdk-box mb-0"
              ...
              >
                <div className="mdk-box__bg">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(/assets/images/1280_derxvssqndm-artem-sapegin.jpg)", //I have to add background image here
                    }}
                  ></div>
                </div>
                <div className="mdk-box__content justify-content-center">
                  <div className="hero container-fluid page__container text-center py-112pt">
                    ...
                    <p
                      className="lead measure-hero-lead mx-auto text-black text-shadow mb-48pt"
                      style={{ color: "black" }}
                    >
                    ...
                    <Link
                      to="/courses"
                      className="btn btn-lg btn-black text-white btn--raised mb-16pt"
                    >
                      Browse Courses
                    </Link>
