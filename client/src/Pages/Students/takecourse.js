...
import { AddCompletedVideosAction } from "../../Actions/courseActions";
...
class TakeCourse extends React.Component {
  ...
  componentDidUpdate = () => {
    ...
    aud.onended = function () {
      var array = self.state.completedvideo;
      if (array.includes(self.state.lecture) === false)
        array.push(self.state.lecture);
      self.setState({
        completedvideo: array,
      });
    };
    self.props.AddCompletedVideosAction(
      self.state.lecture,
      this.props.match.params.id
    );
    console.log(self.state.completedvideo);
  };
          ...
          {section.taskList.map((lecture) => {
            ...
            return (
              <li class="accordion__menu-link">
                ...
                >
                  {lecture.VideoName}
                  {this.rendertick(lecture.VideoName)}
                </a>
              </li>
            );
          })}
  ...
  rendertick(a) {
    console.log(this.state.completedvideo.length);
    const b = this.state.completedvideo.length - 1;
    console.log(a);

    console.log("ok");
    if (this.state.completedvideo.length > 0) {
      if (this.state.completedvideo[b].VideoName.includes(a)) {
  ...
  rendervideo = (url) => {
    ...
    return (
      ...
      //     console.log("yesssss");
      //     this.setState({
      //       completedvideo: [...this.state.completedvideo, this.state.lecture],
      //     });
      //   }}
      ///>
    );
